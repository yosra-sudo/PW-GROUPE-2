            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                      <form name="f1"  method="post" action="Modifieevv.php" >
...
?>
        ...
        <tr>
          ...
          <th>Journaliste</th>
             ...
             <th><input type="text" name="jour" value="<?php  echo $of['journaliste']; ?>"/></th>
        </tr>
        <tr>
        <th>titre</th>
          <th><input type="text" name="tit" value="<?php  echo $of['titre']; ?>"/></th>
        </tr>
              <th>Contenu</th>
          <th><input type="text" name="con" value="<?php  echo $of['cont']; ?>"/></th>
         <tr>
          <?php } ?>
        </tr>
        </table>
