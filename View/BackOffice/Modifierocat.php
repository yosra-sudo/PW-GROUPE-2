...
$sql="SELECT * FROM categorie where id_categ=?";
$recipesStatement = $db->prepare($sql);
$recipesStatement->execute([$_GET['id_categ']]);
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                      <form name="f1"  method="post" action="Modifi.php" >
...
?>
        ...
        <tr>
          <input type="hidden" name="id"  value="<?php echo $of['id_categ'] ?>  ">
