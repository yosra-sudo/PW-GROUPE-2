...
?>
                        <tr>
                          ...
                          <td>
                             <a href="Utilisateurs.php?selected_id=<?php echo $of['id'] ?>"> <?php echo $of['username'] ?> </a>
                          </td>
                          <td>
                          <?php echo $of['type'] ?> 
                          </td>
                            ...
                            <?php echo $of['etat'] ?> 
                             ...
                             <td>
                                 <a href="supprimerUser.php?id=<?php echo $of['id'] ?>"> <img src="icons/trash.svg"> </a>
                          </td>
                         
                          <td>
                          <a href="setAdmin.php?id=<?php echo $of['id'] ?>"><img src="icons/person-badge.svg"</a> 
                          </td>
